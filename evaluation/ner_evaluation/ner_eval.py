...
class Evaluator():
    ...
    def evaluate(self):
        ...
        for true_ents, pred_ents in zip(self.true, self.pred):
            ...
            tmp_results, tmp_agg_results,metrics_explainability = compute_metrics(
                filter_named_entities(true_ents,self.tags),
                filter_named_entities(pred_ents,self.tags),
                self.tags
            )
            res_dict['results'] = metrics_explainability
            res_agg.append(res_dict)
        ...
        return self.results, self.evaluation_agg_entities_type,res_agg

def filter_named_entities(entities,tags):
    named_entities = []
    for entity in entities:
        if entity.e_type in tags:
...
def compute_metrics(true_named_entities, pred_named_entities, tags):
    exact_explainability = []
    strict_explainability = []
    partial_explainability = []
    type_explainability = []
    spurious_explainability = []
    missed_explainability = []
    ...
    for pred in pred_named_entities:
        ...
        if pred in true_named_entities:
            strict_explainability.append((pred,pred))
            ...
            for true in true_named_entities:
                ...
                if true.start_offset == pred.start_offset and pred.end_offset == true.end_offset \
                    ...
                    exact_explainability.append((true,pred))
                ...
                # check for an overlap i.e. not exact boundary match, with true entities
                    ...
                    if pred.e_type == true.e_type:
                        type_explainability.append((true,pred))
                    ...
                    # different.
                        ...
                        partial_explainability.append((true,pred))
                        # overall results
                        evaluation['strict']['incorrect'] += 1
                        evaluation['ent_type']['incorrect'] += 1
                        evaluation['partial']['partial'] += 1
            ...
            if not found_overlap:
                ...
                # Overall results
                spurious_explainability.append((pred))
    ...
    for true in true_named_entities:
        if true in true_which_overlapped_with_pred:
            ...
            missed_explainability.append((true))
            # overall results
    ...
    explainability = {}
    explainability['exact'] = exact_explainability
    explainability['strict'] = strict_explainability
    explainability['partial'] = partial_explainability
    explainability['type'] = type_explainability
    explainability['spurious'] = spurious_explainability 
    explainability['missed'] = missed_explainability 

    return evaluation, evaluation_agg_entities_type,explainability
